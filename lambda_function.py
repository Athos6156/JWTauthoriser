...
def lambda_handler(event, context):
   ...
   # Decode the JWT token and set the policy
    try:
        decoded_token = jwt.decode(token, "55f7bb3f66b9428d876741d05fdf6e52172f8cda5900c8354778b8040030d245", algorithms=["HS256"])
        # Token is valid – proceed with allowing the method
